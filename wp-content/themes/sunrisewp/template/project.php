<?php get_header(); ?>
<?php /* Template Name: Dự án - Theme */ ?>
<?php
$list_project = get_field('list_project',get_the_ID());
?>
<section class="section-project" >

    <div class="container">
        <div class="title">
            <h2><?= $list_project['title']?></h2>
        </div>
                ...
                <div class="child">
                    <div class="image">
                        <a href="<?php the_permalink(); ?>">
                            <?php
                            $img_post = get_the_post_thumbnail_url(get_the_ID(), 'full');
                            ?>
                            <figure>
                                <img src="<?= (!empty($img_post)) ? $img_post : getimage(img_default()) ?>"
                                     alt="" class="img-fluid">
                            </figure>
                        </a>
                    </div>
